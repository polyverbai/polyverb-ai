...
<a
  ...
  className="group flex items-center justify-center w-16 h-16 rounded-full bg-red-500 hover:bg-cyan-400 transition-all duration-300"
>
  <svg
    width="24"
    height="24"
...
<a
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="group flex items-center justify-center w-10 h-10 rounded-full border border-transparent hover:border-[#67E8F9] hover:bg-[#67E8F9]/20 transition-all duration-300"
>
  <svg
    width="20"
    height="20"
    viewBox="0 0 24 24"
    fill="currentColor"
    className="text-gray-400 transition-all duration-300 group-hover:text-[#67E8F9] group-hover:scale-110"
  >
