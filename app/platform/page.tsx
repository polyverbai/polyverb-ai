  ...
  const platformItems = [
    {
      ...
      desc: "Advanced multilingual AI models built for enterprise-grade translation accuracy, context, and scale.",
      href: "/platform/ai-language-engine",
      icon: <Brain size={22} />,
    },
    {
      title: "Workflow Automation",
      desc: "Automate content ingestion, routing, QA, approvals, and multilingual delivery workflows.",
      href: "/platform/workflow-automation",
      icon: <Workflow size={22} />,
    },
    {
      title: "Continuous Localization",
      desc: "Integrate localization directly into product releases, updates, and agile development cycles.",
      href: "/platform/continuous-localization",
      icon: <RefreshCw size={22} />,
    },
    {
      title: "Outcomes",
      desc: "Accelerate launches, improve consistency, reduce effort, and scale global operations.",
      href: "/platform/outcomes",
  ...
  return (
    <main className="bg-transparent text-white overflow-hidden">
      ...
      <section className="relative px-6 md:px-16 py-16">
        ...
        <div className="relative max-w-7xl mx-auto text-center rounded-[36px] border border-white/10 bg-gradient-to-br from-[#0B0F1A] to-[#05070D] px-8 md:px-14 py-16 md:py-20 shadow-[0_0_60px_rgba(34,211,238,0.08)] overflow-hidden">
          <p className="text-[#67E8F9] uppercase tracking-[0.25em] text-sm mb-4">
            Platform
          </p>

          <h1 className="text-4xl md:text-5xl font-semibold leading-tight mb-6">
            The Enterprise Localization <br />
            <span className="text-[#22D3EE]">Platform Built to Scale</span>
          </h1>

          <div className="flex justify-center mb-12">
            <p className="text-gray-400 text-base md:text-lg leading-relaxed text-center max-w-4xl">
              PolyVerb AI unifies AI translation, workflow automation, continuous localization,
              and measurable business outcomes into one intelligent platform for global growth.
            </p>
          </div>
          ...
          <div className="mb-14 text-center">
            ...
            <div className="flex justify-center">
              <p className="text-gray-400 text-center leading-relaxed max-w-3xl">
                Explore the building blocks of a faster, smarter, and scalable localization ecosystem.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-[#67E8F9] uppercase text-sm tracking-widest mb-4">
                Why PolyVerb Platform
              </p>

              <h2 className="text-3xl md:text-5xl font-semibold leading-tight mb-6">
                Built for Modern Global Enterprises
              </h2>

              <p className="text-gray-400 leading-relaxed mb-16">
                Replace fragmented tools and manual workflows with one connected platform
                that manages multilingual growth efficiently across products, content,
                teams, and markets.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-[#0B0F1A] border border-white/10 rounded-3xl p-10">

                <div className="space-y-8">

                  <div className="flex items-start gap-4">

                    <Brain className="text-[#22D3EE]" />
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Context-aware multilingual automation.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Streamlined orchestration across teams.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Expand faster across languages and markets.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Reduce delays and manual overhead.
                      </p>
                    </div>
      ...
      <section className="px-6 md:px-16 pb-28">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">
            Ready to Modernize Localization?
          </h2>

          <p className="text-gray-400 mb-16">
            See how PolyVerb AI helps enterprises scale multilingual growth with speed and consistency.
          </p>
