  ...
  const solutionItems = [
    {
      ...
      desc: "Translate enterprise content across formats with speed, quality, and scalability.",
      href: "solutions/global-content-translation",
      icon: <Globe size={22} />,
    },
    {
      title: "Software & App Localization",
      desc: "Adapt applications across languages, markets, and release cycles.",
      href: "solutions/software-localization",
      icon: <MonitorSmartphone size={22} />,
    },
    {
      title: "Website Localization",
      desc: "Deliver culturally relevant multilingual web experiences with SEO impact.",
      href: "solutions/website-localization",
      icon: <Layout size={22} />,
    },
    {
      title: "Multimedia Localization",
      desc: "Subtitles, dubbing, voice-over, and media adaptation for global audiences.",
      href: "solutions/multimedia-localization",
      icon: <Mic size={22} />,
    },
    {
      title: "Interpretation",
      desc: "Real-time language support for meetings, events, and enterprise communication.",
      href: "solutions/interpretation",
      icon: <Headphones size={22} />,
    },
    {
      title: "Testing & QA",
      desc: "Validate multilingual products for quality, usability, and consistency.",
      href: "solutions/testing-qa",
      icon: <CheckCircle size={22} />,
    },
  ];

  const benefits = [
    "End-to-end localization coverage",
    "AI + human quality workflows",
      ...
      <section className="px-6 md:px-16 py-16">
        <div className="max-w-7xl mx-auto text-center rounded-[36px] border border-white/10 bg-gradient-to-br from-[#0B0F1A] to-[#05070D] px-8 md:px-14 py-16 md:py-20 shadow-[0_0_60px_rgba(34,211,238,0.08)]">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold leading-tight mb-6">
            Global Language Solutions <br />
            <span className="text-[#22D3EE]">Built for Enterprise Growth</span>
          </h1>

          <div className="flex justify-center mb-12">
            <p className="text-gray-400 text-base md:text-lg leading-relaxed text-center max-w-4xl">
              PolyVerb AI delivers translation, localization, interpretation,
              testing, and multilingual content solutions that help enterprises
              expand faster with consistency and quality.
            </p>
          </div>
          ...
          <div className="mb-14 text-center">
            ...
            <div className="flex justify-center">
              <p className="text-gray-400 text-center leading-relaxed max-w-3xl">
                Explore enterprise-ready language solutions designed for speed,
                quality, scalability, and global market success.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-16">
                Replace fragmented vendors and disconnected workflows with a
                single scalable solution partner built for multilingual growth
                across content, products, and customer experiences.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-[#0B0F1A] border border-white/10 rounded-3xl p-10 space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Unified Workflows</h4>
                    <p className="text-sm text-gray-400">
                      Manage all multilingual needs in one ecosystem.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      AI efficiency backed by human expertise.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Operational Speed</h4>
                    <p className="text-sm text-gray-400">
                      Launch faster with streamlined delivery.
                    </p>
                  </div>
                </div>
      ...
      <section className="px-6 md:px-16 pb-28">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-16">
            Discover how PolyVerb AI helps enterprises deliver multilingual growth with speed and consistency.
          </p>
